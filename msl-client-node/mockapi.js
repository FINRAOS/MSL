 ...
 **/
exports.setMockRespond = function(server, port, configurations)
{
    var xmlHttp = null;
 ...
 *
 **/
exports.registerTemplate = function(server, port, template, id)
{
	var xmlHttp = null;
    xmlHttp = new XMLHttpRequest();
 ...
 *
 **/
exports.setInterceptXHR = function(server, port, requestPath)
{
    var xmlHttp = null;
    xmlHttp = new XMLHttpRequest();
 ...
 *
 **/
exports.getInterceptedXHR = function(server, port, requestPath, callback)
{
    var xmlHttp = null;
    xmlHttp = new XMLHttpRequest();
 ...
 **/
exports.setParamIgnored = function(server, port, params)
{
    var xmlHttp = null;
    xmlHttp = new XMLHttpRequest();
 ...
 **/
exports.unRegisterMock = function(server, port, requestPath)
{
    var xmlHttp = null;
    xmlHttp = new XMLHttpRequest();
